...
\input{Metric_spaces}
\input{function_series}
\input{differentiable_limit_theorem}
\input{series_of_functions}
...
\input{MTH362_assignments3}
\section{Homework (assignment 4)}
\input{MTH362_assignments4}
\section{Homework (assignment 5)}
\input{MTH362_assignments5}
\end{document}
